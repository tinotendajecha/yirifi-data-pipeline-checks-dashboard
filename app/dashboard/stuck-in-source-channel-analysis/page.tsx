...
export default function StuckInSourceChannelAnalysis() {
  ...
  const handleBulkDownload = () => {
    ...
    const filename = generateFilename('stuck-source-channel-analysis', data.total);
    downloadCSV(data.results as CSVData[], filename);
  };

  const handleSingleDownload = (item: StuckDataItem) => {
    downloadSingleRow(item as CSVData, 'stuck-source-channel-analysis');
  };
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100">Items stuck in channel analysis process</p>
                {lastUpdated && (
