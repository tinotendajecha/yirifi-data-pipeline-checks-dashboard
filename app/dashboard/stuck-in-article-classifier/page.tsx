...
import { RefreshCw, ArrowLeft, FileText, ExternalLink, Download, FileDown, MoreVertical } from 'lucide-react';
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="mb-4 sm:mb-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-start gap-3">
              <Link href="/dashboard">
                <Button
                  variant="outline"
                  size="sm"
                  className="bg-white/20 border-white/30 text-white hover:bg-white/30 transition-all duration-200 flex-shrink-0"
                >
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="truncate">Article Classifier</span>
                </h1>
                <p className="text-blue-100 text-sm sm:text-base mt-1">Documents stuck in classification</p>
                {lastUpdated && (
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-3 sm:items-center sm:justify-end">
              <div className="flex gap-3">
                ...
                <Button
                  onClick={fetchData}
                  disabled={loading}
                  className="bg-[#FFD700] hover:bg-[#FFD700]/90 text-[#3000A5] font-semibold px-4 sm:px-6 py-2 transition-all duration-200 hover:scale-105 flex-shrink-0"
                  size="sm"
                >
            ...
            <CardHeader className="bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-t-lg p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <CardTitle className="text-lg sm:text-xl font-semibold flex items-center gap-2 flex-wrap">
                  <span>Stuck Documents Overview</span>
                  {selectedCountry && (
                ...
                <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                  {displayData && displayData.results && displayData.results.length > 0 && (
                    <Button
                      ...
                      className="bg-[#00E0FF] hover:bg-[#00E0FF]/90 text-white font-semibold px-3 sm:px-4 py-2 transition-all duration-200 hover:scale-105"
                      size="sm"
                    >
            ...
            <CardContent className="p-3 sm:p-6">
              {loading ? (
                ...
                <div className="text-center py-8 sm:py-12">
                  <FileText className="mx-auto h-12 w-12 sm:h-16 sm:w-16 text-green-500 mb-4" />
