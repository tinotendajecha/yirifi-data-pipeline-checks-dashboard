...
export default function StuckInGeneralFileParser() {
  ...
  const handleBulkDownload = () => {
    ...
    const filename = generateFilename('stuck-general-file-parser', data.total);
    downloadCSV(data.results as CSVData[], filename);
  };

  const handleSingleDownload = (item: StuckDataItem) => {
    downloadSingleRow(item as CSVData, 'stuck-general-file-parser');
  };
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100">Files stuck in the parsing process</p>
                {lastUpdated && (
