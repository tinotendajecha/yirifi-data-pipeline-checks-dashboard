...
export default function StuckInWebsiteScraping() {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await fetch('/api/checks/stuck-in-website-scraping');
      if (response.ok) {
      ...
      console.error('Error fetching website scraping data:', error);
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100">URLs stuck in the scraping process</p>
                {lastUpdated && (
